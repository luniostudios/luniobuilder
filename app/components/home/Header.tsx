                    ...
                    <PopoverContent className="bg-[#111215] text-white border border-white/20 mr-6 mt-4">
                        <PopoverHeader className="ml-4">
                            ...
                            <ul className='flex flex-col gap-4 mt-4'>
                                ...
                                <li><Link href="/documentation" className='text-gray-400 hover:text-gray-300 transition-colors'>Documentation</Link></li>
                                {!session && (
                                    <li><Link href="/auth/signin" className="flex flex-row text-white mt-10 border justify-center border-white/20 px-3 py-3 gap-2 hover:bg-white/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">👤 Sign In</Link></li>
                                )}
                                {session && (
                                    <div>
                                        <Link href="/dashboard">
