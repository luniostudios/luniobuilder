  ...
  return (
    <section className='mt-6 rounded-3xl border border-gray-800 bg-[#111214] p-6 space-y-5'>
      ...
      <div className='grid gap-4 md:grid-cols-3'>
        ...
        <label className='flex items-end gap-2 pb-2 text-sm text-gray-300'><input type='checkbox' checked={settings.enabled} onChange={event => setSettings({ ...settings, enabled: event.target.checked })} /> Enable shop payments</label>
      </div>
