  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} bg-[#111114]`}>
      ...
      <body className="min-h-full flex flex-col">
        <Analytics />
        <Link href="https://discord.gg/WwmW6Mgaxn" target='blank' className='fixed z-20 bottom-25 right-6 text-white border justify-center border-white/20 rounded-full px-3 py-3 items-center gap-2 bg-[#5865F2] hover:bg-[#5865F2]/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed'>
